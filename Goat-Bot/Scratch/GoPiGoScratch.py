...
while True:
    ...
    ##### new block for Goatbot
		elif msg.lower()=="STARTBUTTON".lower(): 
                  Goatbot.wait_start_button()
		elif msg.lower()=="FLAME".lower():
                    if Goatbot.check_flame_sensor_A()==1:
				print("Flame Sensor A see a Candle")
				print("Turn on the Red LED")
				Goatbot.red_led_on()
                       s.sensorupdate({'flame':1})
                   else:
                       s.sensorupdate({'flame':0})                               
            elif msg.lower()=="REDON".lower():
                Goatbot.red_led_on()
            elif msg.lower()=="REDOFF".lower():
                Goatbot.red_led_on()
            elif msg.lower()=="FANON".lower():
                Goatbot.turn_on_fan()
            elif msg.lower()=="FANOFF".lower():
                Goatbot.turn_off_fan()
            elif msg.lower()=="HEADING".lower():
                Goatbot.correct_heading()
            elif msg.lower()=="PUTOFFCANDLE".lower():
                Goatbot.put_off_candle()
            elif msg.lower()=="SEARCHCANDLE".lower():
                Goatbot.search_candle()
            elif msg.lower()=="ROOMSEARCH".lower():
                Goatbot.room_searching()
		# PIVOTPI
