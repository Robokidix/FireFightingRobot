...
def goatbot_right_rot_low(degree):
    set_speed(LOWSPEED)
    if degree<12:
		degree=12
    #Rotate right both wheel
...
def goatbot_left_rot_low(degree):
    set_speed(LOWSPEED)
    if degree<12:
		degree=12
    #Rotate left both wheel
