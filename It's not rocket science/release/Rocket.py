...
SERVOR_RIGHT=30 #Teddybot 0; goatbot 20; rocketbot 30
SERVOR_LEFT=160 #Teddybot 140; goatbot 160; rocketbot 160
DELAY=2
HIGHSPEED=60 #Teddybot 50; rocket 80; Liambot 30
LOWSPEED=50
    ...
    for x in range(1):
        ...
        if dist_front > DIST_2_F_WALL_CLOSE:
            if dist_right<DIST_2_R_WALL_TOO_FAR:
                ...
                #follow_wall(dist_front,dist_right)
                rocket_fwd(15)
                rocket_right_rot(rotation_angel)
        else:
			 servo(SERVOR_LEFT)
			 time.sleep(DELAY)
			 ...
			 if dist_right > dist_left:
				...
				rocket_right_rot(rotation_angel)
				 ...
				 rocket_left_rot(rotation_angel)
